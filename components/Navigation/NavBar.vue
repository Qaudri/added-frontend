<template>
  <nav class="bg-white duration-300 ease-in-out w-full relative lg:absolute z-0 lg:z-20">
    <div class="flex container mx-auto items-center max-w-7xl justify-between px-6 py-4 w-full">
      ...
      <UiButtonsMenu @toggleMenu="toggleMenu()" />
      <nav :class="menu_revealed ? 'translate-x-0' : '-translate-x-full'" class="md:h-fit z-[9999999] md:static md:bg-transparent w-full md:w-fit fixed h-screen left-0 top-[72px] md:top duration-150 ease-in-out md:translate-x-0 bg-white">
